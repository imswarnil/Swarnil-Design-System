...
export function readTokens() {
	...
	return {
		...
		interaction: semantic.filter(is(/^--im-(accent-hover|accent-active|ring|ring-width|ring-offset|opacity-disabled)$/)),
		media: semantic.filter(is(/^--im-(on-media|on-media-dim|on-media-faint|media-ink|glass|glass-soft|glass-light|media-scrim)$/)),
		layers: semantic.filter(is(/^--im-z-/)),
		code: withDark(code),
