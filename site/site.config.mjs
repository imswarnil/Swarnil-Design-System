...
export const navigation = [
	...
	},
	{
		...
		items: [
			...
			{ label: 'Author', url: '/components/author/' },
			...
			{ label: 'Card', url: '/components/card/' },
			{
				...
				icon: 'layout-grid',
				children: [
					{ label: 'The frame', url: '/components/widgets/' },
					{ label: 'Author', url: '/components/widgets/author/' },
					{ label: 'Series', url: '/components/widgets/series/' },
					{ label: 'Most read', url: '/components/widgets/most-read/' },
					{ label: 'Latest', url: '/components/widgets/latest/' },
					{ label: 'Things I use', url: '/components/widgets/things-i-use/' },
					{ label: 'Support', url: '/components/widgets/support/' },
					{ label: 'Newsletter', url: '/components/widgets/newsletter/' },
					{ label: 'Topics', url: '/components/widgets/topics/' },
					{ label: 'On this page', url: '/components/widgets/on-this-page/' },
					{ label: 'About this post', url: '/components/widgets/about-this-post/' },
					{ label: 'Now', url: '/components/widgets/now/' },
					{ label: 'Quote', url: '/components/widgets/quote/' },
					{ label: 'Archive', url: '/components/widgets/archive/' },
					{ label: 'Featured', url: '/components/widgets/featured/' },
					{ label: 'Sponsor', url: '/components/widgets/sponsor/' },
					{ label: 'Follow & search', url: '/components/widgets/follow-and-search/' },
				],
			},
	...
	},
	{
		...
		icon: 'brand-youtube',
		items: [
			{ label: 'Overview', url: '/content-creation/' },
			{
				label: 'YouTube',
				icon: 'brand-youtube',
				children: [
					{ label: 'YouTube', url: '/content-creation/youtube/' },
					{ label: 'Channel art', url: '/content-creation/youtube/channel-art/' },
					{ label: 'Profile art', url: '/content-creation/youtube/profile-art/' },
					{ label: 'The thumbnail', url: '/content-creation/youtube/thumbnail/' },
					{ label: 'The grid', url: '/content-creation/youtube/grid/' },
				],
			},
			{
				label: 'Thumbnails',
				icon: 'image',
				children: [
					{ label: 'Thumbnails', url: '/content-creation/thumbnails/' },
					{ label: 'Film', url: '/content-creation/thumbnails/default/' },
					{ label: 'Live stream', url: '/content-creation/thumbnails/live/' },
					{ label: 'Travel', url: '/content-creation/thumbnails/travel/' },
					{ label: 'Tutorial', url: '/content-creation/thumbnails/tutorial/' },
					{ label: 'Series', url: '/content-creation/thumbnails/series/' },
					{ label: 'Short', url: '/content-creation/thumbnails/short/' },
				],
			},
		],
	},
	{
		...
		icon: 'video',
		items: [
			{ label: 'Live stream', url: '/live/' },
			{ label: 'Starting soon', url: '/live/starting-soon/' },
			{ label: 'The live layout', url: '/live/live-layout/' },
	...
	},
	{
		...
		items: [
			...
			{ label: 'With an AI: skill & MCP', url: '/guides/ai/' },
