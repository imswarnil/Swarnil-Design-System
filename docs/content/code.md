...
<figure class="codeplayer codeplayer-ln">
  ...
  <div class="codeplayer__screen">
    <pre class="codeplayer__pre"><code><span class="codeplayer__ln"><span class="tok-com">/* three variables, whole rebrand */</span></span><span class="codeplayer__ln"><span class="tok-sel">:root</span> <span class="tok-punc">{</span></span><span class="codeplayer__ln">  <span class="tok-prop">--accent</span><span class="tok-punc">:</span> <span class="tok-str">oklch(63% 0.19 34)</span><span class="tok-punc">;</span></span><span class="codeplayer__ln">  <span class="tok-prop">--radius-md</span><span class="tok-punc">:</span> <span class="tok-num">8px</span><span class="tok-punc">;</span></span><span class="codeplayer__ln">  <span class="tok-prop">--font-body</span><span class="tok-punc">:</span> <span class="tok-str">'Geist'</span><span class="tok-punc">;</span></span><span class="codeplayer__ln"><span class="tok-punc">}</span></span></code></pre>
  </div>
</figure>
:::
