...
[`.card-tile`](https://bulma.io/documentation/components/card/) — media behind the words — and it is the only card
...
[Article](https://bulma.io/documentation/elements/content/) page available inside it. `.pager` — the plain one —
