...
<ul class="list w-lg">
  ...
  <li><a class="list__item" href="#i"><span class="list__lead"><span class="avatar avatar-sm">A</span></span><span class="list__body"><span class="list__title">Aisha Bello</span><span class="list__desc">Shared episode 12</span></span><span class="list__end"><span class="tag is-primary">New</span></span></a></li>
</ul>
:::
